...
static int lis2dh_raw_read(const struct device *dev, uint8_t reg_addr, uint8_t *value, size_t len)
{
...
static int lis2dh_raw_write(const struct device *dev, uint8_t reg_addr, uint8_t *value, size_t len)
{
	const struct lis2dh_config *cfg = dev->config;
