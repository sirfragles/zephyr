...
#define LIS2DH_ACCEL_EN_BITS (LIS2DH_ACCEL_X_EN_BIT | LIS2DH_ACCEL_Y_EN_BIT | LIS2DH_ACCEL_Z_EN_BIT)
...
#define LIS2DH_OPER_MODE_IDX 0
#elif defined(CONFIG_LIS2DH_OPER_MODE_HIGH_RES)
#define LIS2DH_LP_EN_BIT     0
#define LIS2DH_OPER_MODE_IDX 2
#else
#define LIS2DH_LP_EN_BIT     0
#define LIS2DH_OPER_MODE_IDX 1
#endif
...
#define LIS2DH_FIFO_INT1_MASK    (LIS2DH_EN_FIFO_WTM_INT1 | LIS2DH_EN_FIFO_OVRN_INT1)
...
#if defined(CONFIG_LIS2DH_ACCEL_RANGE_2G) || defined(CONFIG_LIS2DH_ACCEL_RANGE_RUNTIME)
...
#define LIS2DH_FIFO_EN_BIT BIT(6)
...
#define LIS2DH_FIFO_MODE_SHIFT          6
#define LIS2DH_FIFO_MODE_MASK           (BIT_MASK(2) << LIS2DH_FIFO_MODE_SHIFT)
#define LIS2DH_FIFO_MODE_BYPASS         (0U << LIS2DH_FIFO_MODE_SHIFT)
#define LIS2DH_FIFO_MODE_FIFO           (1U << LIS2DH_FIFO_MODE_SHIFT)
#define LIS2DH_FIFO_MODE_STREAM         (2U << LIS2DH_FIFO_MODE_SHIFT)
#define LIS2DH_FIFO_MODE_STREAM_TO_FIFO (3U << LIS2DH_FIFO_MODE_SHIFT)
#define LIS2DH_FIFO_TRIGGER_INT2        BIT(5)
#define LIS2DH_FIFO_THRESHOLD_MASK      BIT_MASK(5)

#define LIS2DH_REG_FIFO_SRC      0x2F
#define LIS2DH_FIFO_SRC_WTM      BIT(7)
#define LIS2DH_FIFO_SRC_OVRN     BIT(6)
#define LIS2DH_FIFO_SRC_EMPTY    BIT(5)
#define LIS2DH_FIFO_SRC_FSS_MASK BIT_MASK(5)

#define LIS2DH_FIFO_DEPTH       32U
#define LIS2DH_FIFO_SAMPLE_SIZE 6U
#define LIS2DH_FIFO_MAX_BYTES   (LIS2DH_FIFO_DEPTH * LIS2DH_FIFO_SAMPLE_SIZE)
...
struct lis2dh_transfer_function {
	int (*read_data)(const struct device *dev, uint8_t reg_addr, uint8_t *value, size_t len);
	int (*write_data)(const struct device *dev, uint8_t reg_addr, uint8_t *value, size_t len);
...
struct lis2dh_data {
	...
	uint8_t fifo_irq_mask;
	bool fifo_stream_active;
#endif
};

#if DT_ANY_INST_ON_BUS_STATUS_OKAY(spi)
int lis2dh_spi_access(struct lis2dh_data *ctx, uint8_t cmd, void *data, size_t length);
#endif
...
void lis2dh_setup_int1(const struct device *dev, bool enable);
